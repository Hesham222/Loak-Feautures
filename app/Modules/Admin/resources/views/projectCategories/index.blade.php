...
@if(request()->input('view')=='trash')
  <x-slot name="pageTitle">Project Categories | Trash</x-slot name="pageTitle">
  @section('projectCategories-trash-active', 'm-menu__item--active')
@else
  <x-slot name="pageTitle">Project Categories | View</x-slot name="pageTitle">
  @section('projectCategories-view-active', 'm-menu__item--active')
@endif
@section('projectCategories-active', 'm-menu__item--active m-menu__item--open')
        ...
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__head-tools">
              <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                  <a href="{{route('admins.projectCategory.create')}}"
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Admin::projectCategories.components.filterForm')
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('admins.projectCategory.data',['view' => request()->input('view',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('admins.projectCategory.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
        });
    });
  </script>
</x-slot>
