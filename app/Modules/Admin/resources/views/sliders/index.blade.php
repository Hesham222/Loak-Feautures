...
@if(request()->input('view')=='trash')
  <x-slot name="pageTitle">Slider | Trash</x-slot name="pageTitle">
  @section('sliders-trash-active', 'm-menu__item--active')
@else
  <x-slot name="pageTitle">Slider | View</x-slot name="pageTitle">
  @section('sliders-view-active', 'm-menu__item--active')
@endif
@section('sliders-active', 'm-menu__item--active m-menu__item--open')
            ...
            <div class="m-portlet__head-tools">
              <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                  <a href="{{route('admins.slider.create')}}"
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('admins.slider.data',['view' => request()->input('view',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('admins.slider.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
        });
    });
  </script>
</x-slot>
