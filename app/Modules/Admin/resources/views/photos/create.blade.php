<x-admin::layout>
 <x-slot name="pageTitle">Photos | Create</x-slot name="pageTitle">
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('admins.photo.store')}}" enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                      @csrf
                      <div class="m-portlet__body">
                              ...
                              <div class="col-lg-6">
                                  ...
                                  <select name="photo_category_id" required=""
                                      ...
                                      @foreach($photo_categories as $photo_category)
                                          <option @if(old('photo_category_id')== $photo_category->id) selected @endif
