...
@if(request()->input('view')=='trash')
  <x-slot name="pageTitle">Photos | Trash</x-slot name="pageTitle">
  @section('photos-trash-active', 'm-menu__item--active')
@else
  <x-slot name="pageTitle">Photos | View</x-slot name="pageTitle">
        ...
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__head-tools">
              <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                  <a href="{{route('admins.photo.create')}}"
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Admin::photos.components.filterForm')
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('admins.photo.data',['view' => request()->input('view',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('admins.photo.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val()+ '&category=' + $('#photoCategoryColumn').val());
        });
    });
  </script>
</x-slot>
