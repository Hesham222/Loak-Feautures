            ...
            <td>
                @if(request()->query('view')=='trash')
                    <a
                        ...
                        onclick="injectModalData('{{$record->id}}', '{{route('admins.video.restore')}}', 'confirm-password-form', 'POST')"
                    >
                    ...
                    <a
                        ...
                        data-toggle="modal"
                        data-target="#confirm-password-modal"
                        onclick="injectModalData('{{$record->id}}', '{{route('admins.video.destroy', $record->id)}}', 'confirm-password-form', 'DELETE')"
                    >
                        <i class="fa fa-trash" style="color: #fff"></i>
                    </a>
                @else
                    <a
                        href="{{route('admins.video.edit',$record->id)}}"
                        title="Edit"
                        class="btn btn-sm btn-primary">
                        ...
                        <a
                            ...
                            data-toggle="modal"
                            data-target="#confirm-password-modal"
                            onclick="injectModalData('{{$record->id}}', '{{route('admins.video.trash')}}', 'confirm-password-form', 'POST')" >
                            <i class="fa fa-trash" style="color: #fff"></i>
                        </a>
                    <a
                        href="{{route('admins.video.storeFeature',$record->id)}}"
