          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('admins.project.update.section', $record->id)}}" enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                      @csrf
                      @method('post')
                      <div class="m-portlet__body">
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  ...
                                  <h4>{{ $record->ProjectSectionType->name }}</h4>
                              </div>
                          </div>
                          <div class="form-group m-form__group row">
