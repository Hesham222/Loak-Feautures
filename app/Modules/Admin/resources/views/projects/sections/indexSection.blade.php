<x-admin::layout>
        ...
        <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        <li class="m-portlet__nav-item">
                            <a href="{{route('admins.project.create.section',$record->id)}}"
            ...
            <div class="m-portlet__body">
                <section class="content">
                    @include('Admin::projects.sections.components.filterForm')
    ...
    <x-slot name="scripts">
        <script>
            $(function () {
                render("{!! route('admins.project.section.data',['view' => request()->input('section',0),'record_id'=>$record->id]) !!}");
                /**
                ...
                $('#searchButton').on('click', function (event) {
                    event.stopPropagation();
                    render("{!! route('admins.project.section.data',['view' => request()->input('view',0),'record_id'=>$record->id]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val()+ '&sectionType=' + $('#sectionTypeColumn').val());
                });
            });
        </script>
    </x-slot>
