          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('admins.project.section.store')}}" enctype="multipart/form-data"
                        class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                      @csrf
                      <div class="m-portlet__body">
                          <div class="form-group m-form__group row">
                              <input hidden name="project_id" value="{{$record_id}}">
                              <div class="col-lg-6">
                              ...
                              <div id="appendOptions" class="col-lg-6">
                                  @include('Admin::projects.sections.append_options')
                              </div>
  ...
  <x-slot name="scripts">
      <script>
          $('#section_type_id').change(function(){
              ...
              $.ajax({
                  type:'get',
                  url:'{{route('admins.project.append.options')}}',
                  data:{
                      "_token": "{{ csrf_token() }}",
