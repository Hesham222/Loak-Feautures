<x-admin::layout>
 <x-slot name="pageTitle">Projects | Edit</x-slot name="pageTitle">
          ...
          <div class="m-portlet__body">
            <div class="table-responsive">
                <section class="content">
                  <form method="POST" action="{{route('admins.project.update', $record->id)}}" enctype="multipart/form-data"
                      ...
                      <div class="m-portlet__body">
                              ...
                              <div class="col-lg-6">
                                  ...
                                  <select name="project_category_id" required=""
                                      ...
                                      @foreach($project_categories as $project_category)
                                          <option @if(old('project_category_id')== $project_category->id || $project_category->id==$record->project_category_id) selected @endif
                          ...
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  ...
                                  @if($record->image)
                                      @if(pathinfo($record->image, PATHINFO_EXTENSION) == 'mp4')
                                          ...
                                          <input type="hidden" name="mb4" value="{{ $record->image}}">
                                      @else
                              ...
                              <div class="col-lg-6">
                                  ...
                                  <input
                                      type="number"
                                      step="0.01"
                                      value="{{old('area')?old('area'):$record->area}}"
                                      name="area"
                                      required=""
                                      class="form-control m-input"
                                  />
                          ...
                          <div class="form-group m-form__group row">
                              <div class="col-lg-6">
                                  ...
                                  <textarea id="location" name="location" rows="4" cols="50">{{ $record->location }}</textarea>
                                  @error('location')
                                  <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
