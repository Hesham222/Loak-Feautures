...
@if(request()->input('view')=='trash')
  <x-slot name="pageTitle">Messages | Trash</x-slot name="pageTitle">
  @section('messages-trash-active', 'm-menu__item--active')
@else
  <x-slot name="pageTitle">Messages | View</x-slot name="pageTitle">
  @section('messages-view-active', 'm-menu__item--active')
@endif
@section('messages-active', 'm-menu__item--active m-menu__item--open')
        ...
        <div class="m-portlet m-portlet--mobile">
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Admin::messages.components.filterForm')
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('admins.message.data',['view' => request()->input('view',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('admins.message.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
        });
    });
  </script>
</x-slot>
