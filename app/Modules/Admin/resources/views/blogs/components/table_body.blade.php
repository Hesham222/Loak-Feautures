            ...
            <td>
                @if(request()->query('view')=='trash')
                    <a
                        ...
                        onclick="injectModalData('{{$record->id}}', '{{route('admins.blog.restore')}}', 'confirm-password-form', 'POST')"
                    >
                    ...
                    <a
                        ...
                        data-toggle="modal"
                        data-target="#confirm-password-modal"
                        onclick="injectModalData('{{$record->id}}', '{{route('admins.blog.destroy', $record->id)}}', 'confirm-password-form', 'DELETE')"
                    >
                        <i class="fa fa-trash" style="color: #fff"></i>
                    </a>
                @else
                    <a
                        href="{{route('admins.blog.edit',$record->id)}}"
                        title="Edit"
                        class="btn btn-sm btn-primary">
                        ...
                        <a
                            ...
                            data-toggle="modal"
                            data-target="#confirm-password-modal"
                            onclick="injectModalData('{{$record->id}}', '{{route('admins.blog.trash')}}', 'confirm-password-form', 'POST')" >
                            <i class="fa fa-trash" style="color: #fff"></i>
                        </a>
                    <a
                        href="{{route('admins.blog.storeFeature',$record->id)}}"
                    ...
                    <a
                        href="{{route('admins.blog.sections',$record->id).'?view=section'}}"
                        title="Show Sections"
                        class="btn btn-sm btn-primary">
