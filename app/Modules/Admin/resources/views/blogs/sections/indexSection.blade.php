<x-admin::layout>
        @if(request()->input('view')=='section')
            ...
            @section('blogs-trash-active', 'm-menu__item--active')
        @else
            <x-slot name="pageTitle">Sections | View</x-slot name="pageTitle">
        ...
        <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        <li class="m-portlet__nav-item">
                            <a href="{{route('admins.blog.create.section',$record->id)}}"
            ...
            <div class="m-portlet__body">
                <section class="content">
                    @include('Admin::blogs.sections.components.filterForm')
    ...
    <x-slot name="scripts">
        <script>
            $(function () {
                render("{!! route('admins.blog.section.data',['view' => request()->input('section',0),'record_id'=>$record->id]) !!}");
                /**
                ...
                $('#searchButton').on('click', function (event) {
                    event.stopPropagation();
                    render("{!! route('admins.blog.section.data',['view' => request()->input('view',0),'record_id'=>$record->id]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val()+ '&sectionType=' + $('#sectionTypeColumn').val());
                });
            });
        </script>
    </x-slot>
