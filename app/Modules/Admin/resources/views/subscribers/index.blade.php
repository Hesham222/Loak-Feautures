...
@if(request()->input('view')=='trash')
  <x-slot name="pageTitle">Subscribers | Trash</x-slot name="pageTitle">
  @section('subscribers-trash-active', 'm-menu__item--active')
@else
  <x-slot name="pageTitle">Subscribers | View</x-slot name="pageTitle">
        ...
        <div class="m-portlet m-portlet--mobile">
          ...
          <div class="m-portlet__body">
             <section class="content">
                @include('Admin::subscribers.components.filterForm')
...
<x-slot name="scripts">
  <script>
    $(function () {
        render("{!! route('admins.subscriber.data',['view' => request()->input('view',0)]) !!}");
        /**
        ...
        $('#searchButton').on('click', function (event) {
            event.stopPropagation();
            render("{!! route('admins.subscriber.data',['view' => request()->input('view',0)]) !!}&column=" + $('#searchColumn').val() + '&value=' + $('#searchField').val()+ '&start_date=' + $('#startDateCol').val()+ '&end_date=' + $('#endDateCol').val());
        });
    });
  </script>
</x-slot>
